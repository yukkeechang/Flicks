...
1. using search bar!
2. switching from table view to collection view 

## Video Walkthrough 

Here's a walkthrough of implemented user stories:

<blockquote class="imgur-embed-pub" lang="en" data-id="89CUufe"><a href="//imgur.com/89CUufe">View post on imgur.com</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script>

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes
Adding the refresh control was still a bit confusing because of my weak understanding of swift (still D:)
